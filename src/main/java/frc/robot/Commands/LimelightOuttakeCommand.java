...
public class LimelightOuttakeCommand extends Command {
    ...
    public void execute() {
        ...
        m_outtakeSubsystem.rotate(m_anglePIDController.calculate(m_outtakeSubsystem.getAngle(), m_limelightSubsystem.getShooterAngle(m_limelightSubsystem.getDistance("Trig"))));
    }
