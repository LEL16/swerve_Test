...
public class DrivetrainSubsystem extends SubsystemBase {
  ...
  private class SwerveModule {
    ...
    private final PIDController m_drivePIDController = new PIDController(Constants.DRIVE_KP, Constants.DRIVE_KI, Constants.DRIVE_KD);
    private final PIDController m_turningPIDController = new PIDController(Constants.STEER_KP, Constants.STEER_KI, Constants.STEER_KD);
