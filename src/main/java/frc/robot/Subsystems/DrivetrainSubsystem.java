...
public class DrivetrainSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    ...
    m_poseDistance = Math.hypot(
        Math.abs(this.getPosition().getX() - AllianceUtil.getSpeakerPose("blue").getTranslation().getX()),
        Math.abs(this.getPosition().getY() - AllianceUtil.getSpeakerPose("blue").getTranslation().getY()));

    double m_distanceX = this.getPosition().getX() - AllianceUtil.getSpeakerPose("blue").getTranslation().getX();
    double m_distanceY = this.getPosition().getY() - AllianceUtil.getSpeakerPose("blue").getTranslation().getY();
